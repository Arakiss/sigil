import { DemoLinkCard, DemoGrid } from '@/app/components/demo-card'
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-400 max-w-2xl">
          Explore vestig's capabilities across all Next.js execution contexts.
          Each demo shows logging in action with real-time log streaming below.
        </p>
      </div>
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6">
        ...
        <p className="text-sm text-gray-400">
          Click on any demo to see vestig in action. Logs appear in real-time
          in the panel at the bottom of the page. Try expanding logs to see

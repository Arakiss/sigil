      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mb-4">
            Logging in React Server Components with automatic runtime detection
    ...
    return <div>...</div>
        ...
        <div className="mt-8 bg-green-500/10 border border-green-500/20 rounded-lg p-6">
          ...
          <ul className="text-sm text-gray-400 space-y-2">
            <li>
              • <strong className="text-white">Runtime Detection</strong> — Automatically
              detects Node.js/Bun environment
            </li>
            <li>
              • <strong className="text-white">Structured Logging</strong> — JSON output
              for server-side logs
            </li>
            <li>
              • <strong className="text-white">Child Loggers</strong> — Namespaced logging
              for components
            </li>
            <li>
              • <strong className="text-white">Context Propagation</strong> — Request IDs
              tracked across async operations
            </li>
            <li>
              • <strong className="text-white">Real-time Streaming</strong> — Logs appear
              in the panel below
            </li>
          </ul>
        </div>

      ...
      <div className="mt-6">
        ...
        >
          <div className="space-y-3 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-black/30 border border-white/10 rounded text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-white/30"
              />
            </div>
            <div>
          ...
          <div className="mt-3 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded text-xs text-yellow-400">
            ⚠️ Sensitive fields like email, password, and creditCard are
            automatically sanitized in the log output!
          </div>
        </DemoCard>
      </div>
  ...
  return <button onClick={handleClick}>Click me</button>
      ...
      <div className="mt-8 bg-purple-500/10 border border-purple-500/20 rounded-lg p-6">
        ...
        <ul className="text-sm text-gray-400 space-y-2">
          <li>
            • <strong className="text-white">Browser Detection</strong> —
            Runtime shows as 'browser'
          </li>
          <li>
            • <strong className="text-white">PII Sanitization</strong> — Email,
            password, credit cards are redacted
          </li>
          <li>
            • <strong className="text-white">Unified Logging</strong> — Client
            logs appear in the same panel as server logs
          </li>
          <li>
            • <strong className="text-white">Pretty Console</strong> — Colored
            output in browser devtools
          </li>
          <li>
            • <strong className="text-white">No AsyncLocalStorage</strong> —

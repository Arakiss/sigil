    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 mb-4">
          Full request lifecycle logging with correlation ID propagation
      ...
      <div className="mt-6">
        ...
        >
          <div className="mb-4 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded text-xs text-yellow-400">
            ...
            Check the log panel to see them sanitized!
          </div>
    ...
    return Response.json(data, {
      ...
      <div className="mt-8 bg-orange-500/10 border border-orange-500/20 rounded-lg p-6">
        ...
        <ul className="text-sm text-gray-400 space-y-2">
          <li>
            • <strong className="text-white">Request Lifecycle</strong> — Full
            tracing from request to response
          </li>
          <li>
            • <strong className="text-white">Correlation IDs</strong> — Request
            ID and Trace ID propagation
          </li>
          <li>
            • <strong className="text-white">Response Headers</strong> — IDs
            returned for client-side tracing
          </li>
          <li>
            • <strong className="text-white">Duration Tracking</strong> —
            Performance metrics logged automatically
          </li>
          <li>
            • <strong className="text-white">Error Handling</strong> — Errors
            logged with context preserved
          </li>
        </ul>
      </div>
    </div>
